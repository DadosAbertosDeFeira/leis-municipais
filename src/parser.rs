    ...
    fn should_read_html_and_create_a_lei_with_documento() {
        assert_eq!(
            ...
            Lei {
                ...
                documento_url: Some("https://leis.s3.amazonaws.com/originais/feira-de-santana-ba/2019/lc-122-2019-feira_de_santana-ba.doc".to_string()),
